...
<head>
    ...
    <link rel="stylesheet" href="./../css/signup-mobile.css" media="(max-width: 600px)" />

    <link rel="stylesheet" href="./../css/signup.css" media="(min-width: 601px)" />
...
<body>
    <div class="container" id="container">
        <div class="form-container sign-in">
            <form id="signUpForm" method="post" action="./../model/index.php">
                <h1>Đăng nhập</h1>
