...
<head>
    ...
    <link rel="stylesheet" href="./../css/hoian-mobile.css" media="(max-width: 700px)" />

    <link rel="stylesheet" href="./../css/hoian-tablet.css" media="(min-width: 701px) and (max-width: 1024px)" />

    <link rel="stylesheet" href="./../css/hoian.css" media="(min-width: 1025px)" />
</head>
...
<body>
    ...
    <div class="anh">
        <div class="content">
            ...
            <span class="span1"><i class="fa-sharp fa-solid fa-location-dot"></i> Đà Nẵng,
                VIETNAM</span>
            <span class="span2">Hội An là thành phố cổ nằm ở miền Trung Việt Nam, cách Đà Nẵng khoảng
        ...
        <div class="list1">
            ...
            <div class="item">
                <img src="./../img/Hội An/shutterstock-492044509_main_1479291993715.jpeg" alt="" />
            </div>
            <div class="item">
                <img src="./../img/Hội An/vietnam-hội-an-reflections-asia.jpg" alt="" />
            </div>
        </div>
        <div class="slider">
            <div class="list">
    ...
    <div class="diadiemdulich">
        <div>
            ...
            <p>Chùa Cầu</p>
            <span>Chùa Cầu là ngôi chùa được coi như là biểu tượng của Hội An - một
        ...
        <div>
            ...
            <span>Hội quán Phúc Kiến có không gian rộng và sâu nhất, với lối kiến trúc
        ...
        <div>
            ...
            <span>ây là quần thể nghỉ dưỡng “All in one – tất cả trong một” đầu tiên
        ...
        <div>
            ...
            <span style="text-align: justify">Rừng dừa Bảy Mẫu hay còn có tên gọi khác là rừng dừa Cẩm Thanh, là
        ...
        <div>
            ...
            <span>Hội quán có cái tên vô cùng dân dã là “Chùa ông Bổn”. Hội quán do Hoa
        ...
        <div>
            ...
            <span>Nhà thờ Tộc Trần do một vị quan họ Trần từ Trung Hoa di chuyển về Hội
