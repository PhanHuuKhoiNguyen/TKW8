...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="./../css/banahills-mobile.css"
      media="(max-width: 700px)"
    />

    <link
      rel="stylesheet"
      href="./../css/banahills-tablet.css"
      media="(min-width: 701px) and (max-width: 1024px)"
    />

    <link
      rel="stylesheet"
      href="./../css/banahills.css"
  ...
  <body>
    ...
    <div class="anh">
      ...
      <div class="list1">
        ...
        <div class="item">
          <img
            src="./../img/banahill/Ba-Na-Hills-Luxury-Group-Tour-1-Day-Linh-Ung-pagoda.jpg"
            alt=""
          />
        </div>
      </div>
    ...
    <div class="dichvu">
      ...
      <div>
        <img
          src="./../img/banahill/kham-pha-bi-mat-100-nam-tuoi-chua-ke-ve-ba-na-hills-longphutravel-1.jpg"
          alt=""
        />
      ...
      <div>
        <img
          src="./../img/banahill/lang-phap-ba-na-hills-nguoc-thoi-gian-ve-chau-au-trung-co-2-2.jpg"
          alt=""
        />
      ...
      <div>
        <img
          src="./../img/banahill/sunworld-ba-na-hills-danang-vietnam-entrance-1.jpg"
          alt=""
        />
      ...
      <div>
        <img
          src="./../img/banahill/golden-bridge-bana-hillsvietnamgoldenbridge-8354.jpg"
          alt=""
        />
    ...
    <div class="diadiemdulich">
      ...
      <div>
        <img
          src="./../img/banahill/Le-Jardin-DAmour-Gardens-overview.jpg"
          alt=""
        />
        <p>Vườn hoa Le Jardin D'Amour</p>
        <span
          >Vườn hoa Le Jardin D’Amour bao gồm 9 khu vườn gắn với 9 câu chuyện
      ...
      <div>
        ...
        <p>Khu làng Pháp</p>
        <span
          >Được mệnh danh là “Châu Âu trên đỉnh Bà Nà”, đến khu làng Pháp, bạn
      ...
      <div>
        ...
        <span style="text-align: justify"
          >Hầm rượu cổ Debay là công trình độc đáo được người Pháp xây dựng từ
      ...
      <div>
        <img
          src="./../img/banahill/sun-world-ba-na-hills-quang-truong-nhat-thuc-chinh-thuc-don-khach-tu-14-7-2022-7.jpg"
          alt=""
        />
        <p>Quảng trường Nhật Thực</p>
        <span
          >Một địa điểm du lịch Bà Nà Hills cũng mới, cũng hot không kém đó
      ...
      <div>
        ...
        <span
          >Cầu Vàng hay còn gọi là cầu VàngĐà Nẵng là một trong những công trình
